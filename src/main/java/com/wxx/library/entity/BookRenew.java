...
public class BookRenew {
    ...
    @Schema(description = "关联借阅记录ID（关联borrow_record表的id）", required = true)
    private Long borrowId;

    @Schema(description = "续借用户ID（关联user表的id）", required = true)
    private Long userId;

    @Schema(description = "续借图书ID（关联book表的id）", required = true)
    private Long bookId;
